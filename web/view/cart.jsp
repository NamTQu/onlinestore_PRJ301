<%-- 
    Document   : cart
    Created on : Mar 15, 2023, 10:12:23 PM
    Author     : Admin
--%>
...
<html>
    ...
    <div class="small-container cart-page">
        <table class="table2">
            ...
            <c:forEach items="${requestScope.products}" var="o" varStatus="status">                
            <tr>
                    ...
                    <div class="cart-info">
                        ...
                        <div>
                            ...
                            <form action="removeproduct" method="post">
                                <input type="hidden" name="id_product" value="${o.id}">
                                <input type="submit" class="btn" value="remove">
                            </form>
                        </div>
                    </div>
                </td>
                <td><input type="number" value="${requestScope.pri[status.index].quantity}"></td>
                <td>$ ${o.price}</td>
                
                <td> 
                   $ ${requestScope.pri[status.index].price*requestScope.pri[status.index].quantity} 
                </td>
        ...
        <div class="total-price">
            <form action="order" method="post">
             <table class="table2">
                ...
                <tr>
                    <td colspan="2"><button type="submit" class="checkout">Proceed to checkout &#8594;</button></td>
                </tr>                   
